...
from .views import (
    ...
    GalleryViewSet, ContactMessageViewSet, QueueStatisticsViewSet, ClinicProfileViewSet
)
...
router.register(r'clinic-profile', ClinicProfileViewSet, basename='clinicprofile')
