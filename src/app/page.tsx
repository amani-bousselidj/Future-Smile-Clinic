    ...
    <div className="w-full overflow-hidden bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-10 right-20 w-[500px] h-[500px] bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute bottom-10 left-20 w-[500px] h-[500px] bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
          ...
          <div className="text-center">
            ...
            <div className="mb-12 flex justify-center animate-fade-in-down">
              <div className="relative group">
                <div className="absolute inset-0 bg-white/30 rounded-full blur-3xl group-hover:bg-white/40 transition-all duration-500"></div>
                <img
                  src="/images/logo.png"
                  alt="Future Smile Clinic"
                  className="h-40 w-auto relative z-10 drop-shadow-2xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500"
                />
              </div>
            </div>
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black mb-8 leading-tight animate-fade-in-up">
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white animate-shimmer">
                مرحباً بك في
              </span>
            ...
            <div className="flex items-center justify-center gap-4 mb-8 animate-fade-in">
              ...
              <p className="text-2xl md:text-3xl font-light text-blue-100 max-w-4xl leading-relaxed">
                ✨ رعاية أسنان احترافية بأحدث التكنولوجيا ✨
              </p>
              <div className="h-1 w-20 bg-gradient-to-r from-transparent via-white to-transparent"></div>
            </div>

            <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-blue-50 animate-fade-in animation-delay-500">
              فريق من الأطباء المتخصصين وذوي الخبرة العالية يستخدمون أحدث التقنيات العالمية
              <br />
              <span className="inline-block mt-3 px-6 py-2 bg-white/10 backdrop-blur-sm rounded-full font-bold text-white border-2 border-white/30">
                🎯 ابتسامتك المثالية على بعد خطوة واحدة
              </span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in-up animation-delay-1000">
              <Link href="/appointments">
                <Button
                  size="lg"
                  className="group relative bg-white text-blue-700 hover:bg-blue-50 px-12 py-5 text-xl font-bold shadow-2xl hover:shadow-white/50 transform hover:scale-110 transition-all duration-300 overflow-hidden"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-500 opacity-0 group-hover:opacity-20 transition-opacity"></div>
                </Button>
              </Link>
              ...
              <Link href="/services">
                <Button
                  variant="ghost"
                  size="lg"
                  className="group border-3 border-white/80 text-white hover:bg-white hover:text-blue-700 px-12 py-5 text-xl font-bold shadow-2xl backdrop-blur-sm transform hover:scale-110 transition-all duration-300"
                >
              ...
              <Link href="/contact">
                <Button
                  variant="ghost"
                  size="lg"
                  className="border-3 border-white/60 text-white hover:bg-white/10 px-12 py-5 text-xl font-bold backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
                >
                  <span className="flex items-center gap-3">
                    <span className="text-2xl">📞</span>
                    اتصل بنا
            ...
            {/* Trust Indicators */}
            <div className="mt-16 flex flex-wrap justify-center gap-8 text-blue-100 animate-fade-in animation-delay-1500">
              ...
              <div className="flex items-center gap-2">
                <span className="text-3xl">✓</span>
                <span>10,000+ مريض راضٍ</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-3xl">✓</span>
                <span>20+ طبيب متخصص</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-3xl">✓</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-gray-600 text-xl max-w-3xl mx-auto leading-relaxed">
              نقدم مجموعة واسعة من الخدمات الطبية المتخصصة باستخدام أحدث التقنيات والمعدات الطبية العالمية
            </p>
          </div>
          ...
          {loading ? (
            <div className="flex justify-center py-16">
              <div className="relative">
                <LoadingSpinner />
                <p className="mt-4 text-gray-600 text-center">جاري تحميل الخدمات...</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-gray-300 text-xl max-w-3xl mx-auto leading-relaxed">
              نجمع بين الخبرة الطويلة والتقنيات الحديثة لنقدم لك أفضل تجربة علاجية
            </p>
          </div>
              ...
              >
                <div className="h-full p-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-white/30 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <div className="relative inline-block mb-6">
                    <div className={`w-20 h-20 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center text-white transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                      {feature.icon}
                    </div>
                ...
                {/* Glow Effect */}
                <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} rounded-2xl blur-2xl opacity-0 group-hover:opacity-20 transition-opacity -z-10`}></div>
              </div>
            ))}
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4 pt-6 border-t-2 border-gray-100 relative z-10">
                    <div className={`w-14 h-14 bg-gradient-to-br ${testimonial.color} rounded-full flex items-center justify-center text-white text-2xl font-black shadow-lg group-hover:scale-110 transition-transform`}>
                      {testimonial.avatar}
                    </div>
                    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 py-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-white/90 text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed font-medium">
              احجز موعدك اليوم واحصل على استشارة مجانية + خصم 20% على أول جلسة علاجية
            </p>
            ...
            <div className="mt-12">
              <p className="text-white/80 text-lg font-bold flex items-center justify-center gap-2">
                <svg className="w-6 h-6 animate-pulse text-yellow-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
        ...
        {/* Bottom Wave */}
        <div className="absolute bottom-0 left-0 right-0">
          <svg className="w-full h-24 fill-gray-50" viewBox="0 0 1440 120" preserveAspectRatio="none">
            <path d="M0,64L48,69.3C96,75,192,85,288,80C384,75,480,53,576,48C672,43,768,53,864,64C960,75,1056,85,1152,80C1248,75,1344,53,1392,42.7L1440,32L1440,120L1392,120C1344,120,1248,120,1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z"></path>
          </svg>
        </div>
      </section>
