    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg"
        >
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-6 shadow-sm">
          ...
          <form onSubmit={upsert} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition resize-none"
                rows={3}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {services.map((s) => (
                  <label key={s.id} className="flex items-center gap-2 p-3 rounded-xl border-2 border-gray-200 hover:border-purple-300 cursor-pointer transition">
                    <input
                      type="checkbox"
            ...
            <div className="flex gap-3 pt-2">
              <button
                type="submit"
                disabled={saving}
                className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold disabled:opacity-60 hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg"
              >
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-xs font-bold">{items.length}</span>
          </div>
          <button
            onClick={load}
            disabled={loading}
              ...
              <div key={d.id} className="p-5 hover:bg-gray-50 transition">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-purple-600 font-medium mb-2">{d.specialization}</p>
                    {d.biography && (
                  ...
                  <div className="flex flex-col gap-2 shrink-0">
                    ...
                    <button
                      onClick={() => onEdit(d)}
                      className="px-4 py-2 rounded-xl text-xs font-semibold border-2 border-purple-200 bg-purple-50 text-purple-700 hover:bg-purple-100 transition"
                    >
                      ✏️ تعديل
                    </button>
                    <button
