...
export function Header({ onLoadingComplete = false }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-[280px] bg-white shadow-2xl z-50 transition-transform duration-500 ease-out ${
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6 relative">
          ...
          <button
            ...
            className="absolute top-4 left-4 p-2 rounded-full bg-white/20 text-white hover:bg-white/30 transition-all"
          ...
          <div className="text-white mt-8">
            <h2 className="text-xl font-bold mb-1">Future Smile Clinic</h2>
            <p className="text-sm text-blue-100">ابتسامتك تبدأ من هنا</p>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
          ...
          <Link
            href="/appointments"
            onClick={() => setMobileOpen(false)}
            className="w-full py-3.5 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg text-center font-semibold shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 mb-4"
          >
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500 mb-2">تابعنا على</p>
            <div className="flex justify-center gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-all">
