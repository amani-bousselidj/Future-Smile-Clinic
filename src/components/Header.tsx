    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute top-6 left-6 z-10 w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-gray-800 hover:bg-white/30 transition-all"
            ...
            {navItems.map((item, index) => (
              <Link
                ...
                style={{
                  ...
                  animation: mobileOpen ? "slideInLeft 0.5s ease-out forwards" : "none",
                }}
              >
                <div className={`w-2 h-2 rounded-full transition-all ${
                  activeTab === item.id ? "bg-blue-600 scale-100" : "bg-gray-400 scale-0 group-hover:scale-100"
                }`}></div>
