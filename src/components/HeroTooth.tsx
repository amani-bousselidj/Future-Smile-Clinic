    ...
    <section className="relative w-full overflow-hidden bg-gradient-to-r from-blue-50 via-green-50 to-white">
      <div className="max-w-[1400px] mx-auto px-8 sm:px-12 lg:px-16 py-24 lg:py-32">
        <div className="relative">
          ...
          <svg className="w-full h-[420px] md:h-[520px] block" viewBox="0 0 1400 420" preserveAspectRatio="xMidYMid slice">
            <defs>
              {/* A simple tooth-like path used as mask - adjust if you have an exact SVG */}
              <clipPath id="toothClip">
                <path d="M710 70c22-30 58-30 80 0 24 34 18 58 6 84-12 26-26 38-34 68-8 30-2 60-6 84-4 24-22 42-44 42s-40-18-44-42c-4-24 2-54-6-84-8-30-22-42-34-68-12-26-18-50 6-84 22-30 58-30 80 0z" fill="#fff"/>
              </clipPath>

              {/* mask that hides the text inside the tooth shape */}
              <mask id="toothMask">
                <rect x="0" y="0" width="100%" height="100%" fill="white" />
                <path d="M710 70c22-30 58-30 80 0 24 34 18 58 6 84-12 26-26 38-34 68-8 30-2 60-6 84-4 24-22 42-44 42s-40-18-44-42c-4-24 2-54-6-84-8-30-22-42-34-68-12-26-18-50 6-84 22-30 58-30 80 0z" fill="black" />
              </mask>
            </defs>
            ...
            <g mask="url(#toothMask)">
              ...
              <text x="50%" y="55%" textAnchor="middle" fontFamily="Inter, system-ui, Arial" fontWeight={800}
                fontSize="120" fill="#D6E8E8" style={{letterSpacing: '-0.02em'}}>
                Future Smile Clinic
              </text>
            </g>
          </svg>
          ...
          <div className="relative z-20 pt-12 lg:pt-6 text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900">ابتسامتك تستحق الأفضل</h2>
